module.exports = function({ api, models, Users, Threads, Currencies }) {
  ...
  return async function({ event }) {
    ...
    const isAuthorized = ADMINBOT.includes(senderID) || OWNER.includes(senderID) || OPERATOR.includes(senderID);
    if (!isAuthorized && typeof body === 'string' && body.startsWith(PREFIX)) {
      return;
    }
